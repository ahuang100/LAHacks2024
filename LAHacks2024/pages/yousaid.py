...
useless = ["                                                                                                                                                                                                                                                                                                                ", "                                                                                                                                                                                                                                                                                                                ", "                                                                                                                                                                                                                                                                                                                ", "                                                                                                                                                                                                                                                                                                                "]
name = ["dan", "dandy", "andy", "pan",]
arg = arg1+arg1 + arg1 +useless

names = name + name + name + name

combined_list = [f"{name}: {text}" for name, text in zip(names, arg)]
...
def yousaid_page():
    ...
    first_group = combined_list[:half_num_players]
    second_group = combined_list[half_num_players:]
            ...
            rx.vstack(
                ...
                rx.foreach(
                    ...
                    lambda item, index: rx.box(  # Use 'item' instead of 'arg'
                        rx.text(item, style={"text-align": "left"}),  # Use 'item' instead of 'second_group', set text alignment to right
