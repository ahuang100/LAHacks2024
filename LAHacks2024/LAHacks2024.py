...
from LAHacks2024.pages import theend
...
app.add_page(abilities.abilities_page, route="/abilities")
app.add_page(convinceme.convincemepage, route="/convinceme")
app.add_page(yousaid.yousaid_page, route="/yousaid")
app.add_page(transition.transition_page, route="/transition")
app.add_page(naming.naming_page, route="/naming")
app.add_page(room.room_page)
app.add_page(theend.final_page)